...
export default function TokenProfile({ tokenSlug }) {
  ...
  return (
    <div className="max-w-7xl mx-auto">
          ...
          <div className="lg:ml-auto flex flex-col gap-3">
            ...
            {connectedWallet && (
              <div className="glass rounded-lg p-4 text-center min-w-[200px] bg-purple-500/10 border border-purple-500/30">
                ...
                <div className="text-lg sm:text-xl font-bold text-purple-200 truncate">{userBalance !== null ? userBalance.toFixed(4) : '0.0000'}</div>
                <div className="text-purple-400 text-xs truncate">{token.currency_code}</div>
                <div className="text-green-400 text-sm mt-1 truncate">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:flex gap-2 mb-6 justify-center items-stretch">
        <TokenTrustButton
          token={token}
